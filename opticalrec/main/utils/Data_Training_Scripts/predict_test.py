...
def predict(img_path):
    ...
    new_model = tf.keras.models.load_model(r'Group_10\Training\grayscale_add.h5')
...
mypath = r'Group_Project\group-10\opticalrec\media\frames\zach\393912236526\Good_Extraction'
save = r'\CO2201\Group_10\Training'
used = r'\CO2201\Group_10\Training\used/'
onlyfiles = [f for f in listdir(mypath) if isfile(join(mypath, f))]
for f in onlyfiles:
    predict(r'\243557275636\OppHealth\OppHealth_frame15121.jpg')